...
class MusicStore {
  ...
  static List<BoxShadow> boxShow(BuildContext context,
    ...
    return [
      BoxShadow(
          color: MusicStore.Theme.of(context).bottomShadowColor,
          offset: Offset(bottom,bottom),
          blurRadius: bottom),
      BoxShadow(color: MusicStore.Theme.of(context).topShadowColor, offset: Offset(top,top), blurRadius:top.abs()*2+1.0)
    ];
  }
